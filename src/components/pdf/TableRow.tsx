...
import { Download, FileText, CheckCircle, RefreshCw, AlertCircle, Clock, Trash2 } from 'lucide-react';
      ...
      <td className="px-4 py-4">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            ...
            <div className="text-xs text-gray-500 truncate max-w-xs">{file.sourceUrl}</div>
          </div>
        </div>
      </td>
      <td className="px-4 py-4">

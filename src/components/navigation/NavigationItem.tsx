...
export const NavigationItem = React.memo(({ 
  ...
  useEffect(() => {
    // Defer to the next animation frame to avoid synchronous setState inside the effect
  ...
  return (
    ...
    >
      ...
      {/* Modern active indicator with gradient and glow - matches BrandHeader style */}
      {isActive && !collapsed && (
        <div 
      ...
      {/* Ripple effect on click (professional touch) */}
      <div 
        className={cn(

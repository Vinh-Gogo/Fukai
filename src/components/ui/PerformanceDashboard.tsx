  ...
  ({ isOpen, onClose }) => {
    ...
    const formattedMetrics = useOptimizedMemo(() => {
      ...
      return {
        ...
        measurements: Object.entries(metrics.measurements).map(
          ([name, time]) => ({
            name,
                        ...
                        <div
                          className={`h-2 rounded-full ${
                            parseFloat(formattedMetrics.memory.percentage) > 80
                              ? "bg-red-500"
                              : parseFloat(formattedMetrics.memory.percentage) >
                                  60
                                ? "bg-yellow-500"
                                : "bg-green-500"
                          }`}
                          style={{
                            width: `${formattedMetrics.memory.percentage}%`,
                          }}
                        />
                      </div>
                ...
                <CardContent>
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between text-sm">
                      ...
                      <span>
                        {
                          formattedMetrics.measurements.filter((m) => m.isSlow)
                            .length
                        }
                      </span>
                    </div>

      ...
      {messages.map((message) => (
        ...
        >
          ...
          <div className={getMessageClasses(message.role)}>
            ...
            {/* Message Metadata */}
            <div
              className={`flex items-center justify-between mt-3 pt-3 border-t ${getMessageBorderClasses(message.role)}`}
            >
                ...
                hasMessageConfidence(message) && (
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span
                        className={`text-xs font-medium ${getConfidenceTextColor(message.confidence!)}`}
                      >
                        {message.confidence}%
                      </span>
                    </div>

...
export function withLoading<P extends BaseComponentProps>(
  ...
  const WithLoadingComponent = forwardRef<
    HTMLElement,
    P & { loading?: boolean; loadingText?: string }
  ...
  WithLoadingComponent.displayName = createDisplayName(
    "WithLoading",
...
export function withErrorBoundary<P extends BaseComponentProps>(
  ...
  (WithErrorBoundary as unknown as React.ComponentType).displayName =
    createDisplayName(
      "WithErrorBoundary",
      Component.displayName || Component.name,
    );
...
export function withAnimation<P extends BaseComponentProps>(
  ...
  WithAnimationComponent.displayName = createDisplayName(
    "WithAnimation",
    Component.displayName || Component.name,
  );
